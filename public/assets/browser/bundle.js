  ...
  1: [function (require, module, exports) {
    ...
    Board.prototype.changeStartNodeImages = function () {
      ...
      if (unweighted.includes(this.currentAlgorithm)) {
        if (this.currentAlgorithm === "dfs") {
          $.notify({
            message: `${name} is <i><b>unweighted</b></i> and <i><b>does not guarantee</b></i> the shortest path!`
          }, {
            placement: {
              from: "bottom",
              align: "right"
          ...
          $.notify({
            message: `${name} is <i><b>unweighted</b></i> and <i><b>guarantees</b></i> the shortest path!`
          }, {
            placement: {
              from: "bottom",
              align: "right"
        ...
        for (let i = 0; i < 14; i++) {
          let j = i.toString();
          let backgroundImage = document.styleSheets["3"].rules[j].style.backgroundImage;
          document.styleSheets["3"].rules[j].style.backgroundImage = backgroundImage.replace("triangle", "spaceship");
        }
      } else {
        if (this.currentAlgorithm === "greedy" || this.currentAlgorithm === "CLA") {
          $.notify({
            message: `${name} is <i><b>weighted</b></i> and <i><b>does not guarantee</b></i> the shortest path!`
          }, {
            placement: {
              from: "bottom",
              align: "right"
        ...
        for (let i = 0; i < 14; i++) {
          ...
          let backgroundImage = document.styleSheets["3"].rules[j].style.backgroundImage;
          document.styleSheets["3"].rules[j].style.backgroundImage = backgroundImage.replace("spaceship", "triangle");
        }
      }
      if (this.currentAlgorithm === "bidirectional") {
        $.notify({
      ...
      if (guaranteed.includes(this.currentAlgorithm)) {
        $.notify({
          message: `${name} is <i><b>weighted</b></i> and <i><b>guarantees</b></i> the shortest path!`
        }, {
          placement: {
            from: "bottom",
            align: "right"
    ...
    Board.prototype.toggleTutorialButtons = function () {
      ...
      function nextPreviousClick() {
        if (counter === 1) {
          document.getElementById("tutorial").innerHTML = `<div class="mainTutorialContainer">
      <div class="info">
        <h3>Pathfinder Visualization Tool</h3>
      ...
      <img id="mainTutorialImage" src="/assets/img/c_icon.png">
    </div>

    <div class="tutorialBtnOptions">
      ...
      <button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>
          ...
          <div class="mainTutorialContainer">
            <img id="mainTutorialImage" src="/assets/img/maps.png" style="width: 150px; margin-right: 10px;">
      <div class="info" style="max-width: 400px;">
        <h3 style="position: sticky; margin-left: -50%;">What is a pathfinding algorithm?</h3>
        <h6>At its core, a pathfinding algorithm seeks to find the shortest path between two points.</h6><p>All of the algorithms on this application are adapted for a 2D grid, where 90 degree turns have a "cost" of 1 and movements from a node to another have a "cost" of 1.</p>
        <div id="tutorialCounter">${counter}/9</div>
      </div>
    </div>

    <div class="tutorialBtnOptions">
      <button id="nextButton" class="btn btn-default navbar-btn" type="button" style="bottom: 1%;">Next</button>
      <button id="previousButton" class="btn btn-default navbar-btn" style="right: 92px; bottom: 1%;" type="button">Previous</button>
      <button id="skipButton" class="btn btn-default navbar-btn" style="bottom: 1%;" type="button">Skip Tutorial</button>
    </div>`;
        } else if (counter === 3) {
          document.getElementById("tutorial").innerHTML = `
             <div class="mainTutorialContainer">
      <div class="info" style="max-width: 400px;">
        ...
        <h6>Choose an algorithm from the "Algorithms" drop-down menu.</h6><p>Note that some algorithms are <i><b>unweighted</b></i>, while others are <i><b>weighted</b></i>. Unweighted algorithms do not take turns or weight nodes into account, whereas weighted ones do. Additionally, not all algorithms guarantee the shortest path.</p>
        <div id="tutorialCounter">${counter}/9</div>
      </div>
      <img id="mainTutorialImage" src="/assets/img/algorithms.jpeg" style="width: 300px; margin-right: 10px;">
    </div>
...
<ul><li><b>Dijkstra's Algorithm</b> (weighted): the father of pathfinding algorithms; guarantees the shortest path</li><li><b>A* Search</b> (weighted): arguably the best pathfinding algorithm; uses heuristics to guarantee the shortest path much faster than Dijkstra's Algorithm</li><li><b>Greedy Best-first Search</b> (weighted): a faster, more heuristic-heavy version of A*; does not guarantee the shortest path</li><li><b>Swarm Algorithm</b> (weighted): a mixture of Dijkstra's Algorithm and A*; does not guarantee the shortest-path</li><li><b>Convergent Swarm Algorithm</b> (weighted): the faster, more heuristic-heavy version of Swarm; does not guarantee the shortest path</li><li><b>Bidirectional Swarm Algorithm</b> (weighted): Swarm from both sides; does not guarantee the shortest path</li><li><b>Breath-first Search</b> (unweighted): a great algorithm; guarantees the shortest path</li><li><b>Depth-first Search</b> (unweighted): a very bad algorithm for pathfinding; does not guarantee the shortest path</li></ul>        <div id="tutorialCounter">${counter}/9</div>
    ...
    <div class="tutorialBtnOptions">
      ...
      <button id="skipButton" class="btn btn-default navbar-btn" style="bottom: 1%;" type="button">Skip Tutorial</button>
          ...
          <div class="mainTutorialContainer">
      <div class="info">
        <h3 style="position: sticky; margin-left: -50%;">Adding a bomb</h3>
        <h6>Click the "<span class="addBomb"><i class="fas fa-bomb"></i><i class="fas fa-plus"></i></span>" button.</h6><p>Adding a bomb will change the course of the chosen algorithm. In other words, the algorithm will first look for the bomb (in an effort to diffuse it) and will then look for the target node. Note that the Bidirectional Swarm Algorithm does not support adding a bomb.</p>
        <div id="tutorialCounter">${counter}/9</div>
      </div>
    </div>
    <div class="tutorialBtnOptions">
      ...
      <button id="skipButton" class="btn btn-default navbar-btn" style="bottom: 1%;" type="button">Skip Tutorial</button>
          ...
          document.getElementById("tutorial").innerHTML = `
          <div class="mainTutorialContainer">
            <img id="mainTutorialImage" src="/assets/img/dragging.gif" style="width: 150px; margin-right: 10px;">
      <div class="info">
        <h3>Dragging nodes</h3><h6>Click and drag the start, bomb, and target nodes to move them.</h6><p>Note that you can drag nodes even after an algorithm has finished running. This will allow you to instantly see different paths.</p>
      <div id="tutorialCounter">${counter}/9</div>
      </div>
    </div>
    <div class="tutorialBtnOptions">
      ...
      <button id="skipButton" class="btn btn-default navbar-btn" style="bottom: 1%;" type="button">Skip Tutorial</button>
          ...
          <div class="mainTutorialContainer">
      <div class="info">
        <h3>Visualizing and more</h3><h6>Use the navbar buttons to visualize algorithms and to do other stuff!</h6><p>You can clear the current path, clear walls and weights, clear the entire board, and adjust the visualization speed, all from the navbar. If you want to access this tutorial again, click on the logo in the top left corner of your screen.</p>
        <div id="tutorialCounter">${counter}/9</div>
      </div>
    </div>
    <div class="tutorialBtnOptions">
      ...
      <button id="skipButton" class="btn btn-default navbar-btn" style="bottom: 1%;" type="button">Skip Tutorial</button>
          ...
          <div class="mainTutorialContainer">
      <div class="info">
        <h3>Enjoy!</h3><h6>I hope you have just as much fun playing around with this visualization tool as I had building it!</h6>
      <div id="tutorialCounter">${counter}/9</div>
      </div>
    </div>

    <div class="tutorialBtnOptions">
      <button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button>
      <button id="previousButton" class="btn btn-default navbar-btn" style="right:90px;" type="button">Previous</button>
      <button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>
    </div>`;
    ...
    Board.prototype.toggleButtons = function () {
      ...
      if (!this.buttonsOn) {
        ...
        document.getElementById("adjustFast").onclick = () => {
          this.speed = "fast";
          document.getElementById("adjustSpeed").innerHTML = '<i class="fas fa-tachometer-alt" ></i>: <i class="fas fa-fast-forward"></i><span class="caret"></span>';
        }

        document.getElementById("adjustAverage").onclick = () => {
          this.speed = "average";
          document.getElementById("adjustSpeed").innerHTML = '<i class="fas fa-tachometer-alt" ></i>: <i class="fas fa-forward"></i><span class="caret"></span>';
        }

        document.getElementById("adjustSlow").onclick = () => {
          this.speed = "slow";
          document.getElementById("adjustSpeed").innerHTML = '<i class="fas fa-tachometer-alt" ></i>: <i class="fas fa-caret-right"></i><span class="caret"></span>';
        }
